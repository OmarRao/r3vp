...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("workload_ids", postgresql.JSONB, server_default=sa.text("'[]'::jsonb")),
        sa.Column("checks_enabled", postgresql.JSONB, server_default=sa.text("'{}'::jsonb")),
    ...
    op.create_table(
        ...
        sa.Column("check_results", postgresql.JSONB, server_default=sa.text("'{}'::jsonb")),
